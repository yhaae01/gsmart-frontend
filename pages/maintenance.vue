    ...
    <div class="container mb-10">
      <div class="card shadow-sm mt-5">
        <div class="card-header">
          <h3 class="card-title fw-bold">List of Maintenance</h3>
              ...
              <table class="table table-row-bordered table-row-gray-200 gy-4">
                <thead>
                  <tr class="fw-bold fs-6 text-gray-800">
                    ...
                    <th v-else @click="sort('name', 'asc')" class="text-center">
                      Maintenance Event <i class="fa-solid fa-sort"></i>
                    </th>
                    ...
                    <th
                      ...
                      class="text-center"
                    >
                      Product Group <i class="fa-solid fa-sort"></i>
                    </th>
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="text-center">
                      {{ p_maintenance.product?.name }}
                    </td>
                    <td class="text-center">
                      {{ p_maintenance.description ?? '-' }}
                    </td>
            ...
            >
              <nav>
                <ul class="pagination">
                  <!-- Start pagination -->
                  <li
                    v-for="(link, link_index) in maintenance.links"
                    :key="link_index"
                    class="page-item"
          ...
          <div class="modal-body">
            <form @submit.prevent="submit">
              ...
              <div class="form-group mb-3">
                ...
                <select
                  v-model="p_maintenance.product_id"
                  class="form-select"
...
export default {
  ...
  methods: {
    ...
    create() {
      if (this.p_maintenance.name.includes(';')) {
        Swal.fire({
          icon: 'error',
          title: 'Oops...',
          html: 'Maintenance Name cannot contain <strong>semicolon (;)</strong>',
        })
        return
      }
      ...
      this.$axios
        .post('/api/maintenance-create', {
          ...
          product_id: this.p_maintenance.product_id,
    ...
    edit(p_maintenance) {
      ...
      this.p_maintenance.product_id = p_maintenance.product_id
    ...
    clearForm() {
      ...
      this.p_maintenance.product_id = null
