...
var KTScroll = function (e, t) {
  ...
  if (e) {
    var i = { saveState: !0 },
      ...
      o = function (e) {
        return document.body.hasAttribute('data_kt_name')
          ? document.body.getAttribute('data_kt_name') + '_'
          : ''
      },
      a = function () {
        var e = o()
    ...
    var i = {
      ...
      a = function () {
        ...
        var t = KTUtil.findAll(
          n.element,
          '[data-kt-stepper-element="nav"], [data-kt-stepper-text="text"], [data-kt-stepper-element="content"], [data-kt-stepper-element="info"]'
        )
        if (t && t.length > 0)
...
var KTThemeMode = (function () {
  var e,
    ...
    i = function (e) {
      return (
        'kt_' +
        (document.body.hasAttribute('data_kt_name')
          ? document.body.getAttribute('data_kt_name') + '_'
          : '') +
        'theme_mode_' +
        e
          ...
          [].slice
            ...
            .map(function (e) {
              e.addEventListener('click', function (i) {
                ...
                'system' === r && (a = l()),
                  o(a, r),
                  KTEventHandler.trigger(t, 'kt.thememode.change', n)
              })
            }))
    },
    getMode: function () {
